...
│  for enterprise pricing: support@hanzogui.dev   │
│                                                 │
...
3. **What about companies with significant revenue?**
   ...
   > Companies with over $1M in annual revenue should contact us at support@hanzogui.dev for enterprise pricing. The standard license is intended for bootstrapped companies, solo developers, and early-stage startups.
...
Based on analysis of 10+ files across the hanzogui.dev codebase, these are the patterns to follow:
...
<Theme name="yellow">
  <XStack bg="$color3" rounded="$4" borderWidth={0.5} borderColor="$color8" p="$3">
    <Paragraph size="$3" color="$color11">
      ...
      <Link href="mailto:support@hanzogui.dev">contact us</Link> for enterprise pricing.
    </Paragraph>
  </XStack>
</Theme>
```
