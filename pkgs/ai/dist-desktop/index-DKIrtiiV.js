const index = {
  ...
  tools: {
    ...
    create: {
      ...
      hanzoCodeGeneratorDescription: "Builds tools using our specialized AI code-generation tool.",
      hanzoFreeTrial: "{{appName}} Free Trial",
      hanzoFreeTrialDescription: "Great for building tools, works with any content you provide.",
      hanzoFreeTrialRecommendation: "Manually copy and paste the documentation that the AI requires and place it inside <documentation></documentation>.",
  ...
  networkAgentsPage: {
    ...
    registerHanzoIdentityDescription: "Create your unique identity on the {{appName}} network to use and publish agents",
