...
exports.getBoundingClientRect = exports.canUseDOM = void 0;
...
function getEventPath(domEvent) {
    ...
    if (domEvent.type === 'selectionchange') {
        var target = (_a = window.getSelection()) === null || _a === void 0 ? void 0 : _a.anchorNode;
        return composedPathFallback(target);
    }
    var path = domEvent.composedPath != null
...
function getResponderPaths(domEvent) {
    ...
    return { idPath: idPath, nodePath: nodePath };
}
/**
