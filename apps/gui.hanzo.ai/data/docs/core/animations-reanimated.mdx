...
Add your animations to your [Gui config](/docs/core/configuration):
...
```tsx
import { createAnimations } from '@hanzogui/animations-reanimated'
import { YStack, createGui } from 'hanzogui'
...
The Reanimated driver now works with Gui to bypasses all internal style
