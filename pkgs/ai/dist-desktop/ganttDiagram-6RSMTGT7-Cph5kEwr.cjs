...
const linear = require('./linear-Dw6QccU9.cjs');
...
const interpolateHcl = hcl(index.hue);
...
const millisecond$1 = timeInterval$1(() => {
  // noop
}, (date, step) => {
...
const timeMinute$1 = timeInterval$1((date) => {
...
const utcMinute$1 = timeInterval$1((date) => {
...
const timeHour$1 = timeInterval$1((date) => {
...
const utcHour$1 = timeInterval$1((date) => {
...
const timeMonth$1 = timeInterval$1((date) => {
  date.setDate(1);
  date.setHours(0, 0, 0, 0);
}, (date, step) => {
...
const utcMonth$1 = timeInterval$1((date) => {
  date.setUTCDate(1);
  date.setUTCHours(0, 0, 0, 0);
}, (date, step) => {
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function tickInterval(start, stop, count) {
    ...
    if (i === 0) return millisecond$1.every(Math.max(linear.tickStep(start, stop, count), 1));
...
const [timeTicks, timeTickInterval] = ticker(timeYear$1, timeMonth$1, timeSunday$1, timeDay$1, timeHour$1, timeMinute$1);
    ...
    return function(string) {
      ...
      if ("V" in d) {
        ...
        if ("Z" in d) {
          ...
          week = day > 4 || day === 0 ? timeMonday$1.ceil(week) : timeMonday$1(week);
...
function formatWeekNumberSunday$1(d, p) {
  return pad$1(timeSunday$1.count(timeYear$1(d) - 1, d), p, 2);
}

function dISO$1(d) {
  var day = d.getDay();
  return (day >= 4 || day === 0) ? timeThursday$1(d) : timeThursday$1.ceil(d);
}

function formatWeekNumberISO$1(d, p) {
  d = dISO$1(d);
  return pad$1(timeThursday$1.count(timeYear$1(d), d) + (timeYear$1(d).getDay() === 4), p, 2);
}
...
function formatWeekNumberMonday$1(d, p) {
  return pad$1(timeMonday$1.count(timeYear$1(d) - 1, d), p, 2);
}
...
function formatFullYearISO$1(d, p) {
  var day = d.getDay();
  d = (day >= 4 || day === 0) ? timeThursday$1(d) : timeThursday$1.ceil(d);
  return pad$1(d.getFullYear() % 10000, p, 4);
}
...
function time() {
  return init.initRange.apply(calendar(timeTicks, timeTickInterval, timeYear$1, timeMonth$1, timeSunday$1, timeDay$1, timeHour$1, timeMinute$1, second$1, timeFormat$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
}
...
const dayjsIsoWeek = /*@__PURE__*/index.getDefaultExportFromCjs(isoWeekExports);
...
const dayjsCustomParseFormat = /*@__PURE__*/index.getDefaultExportFromCjs(customParseFormatExports);
...
const dayjsAdvancedFormat = /*@__PURE__*/index.getDefaultExportFromCjs(advancedFormatExports);
...
const dayjsDuration = /*@__PURE__*/index.getDefaultExportFromCjs(durationExports);
...
index.dayjs2.extend(dayjsIsoWeek);
index.dayjs2.extend(dayjsCustomParseFormat);
index.dayjs2.extend(dayjsAdvancedFormat);
...
var setDiagramId = /* @__PURE__ */ index.__name(function(id) {
  diagramId = id;
}, "setDiagramId");
var setAxisFormat = /* @__PURE__ */ index.__name(function(txt) {
  axisFormat = txt;
}, "setAxisFormat");
var getAxisFormat = /* @__PURE__ */ index.__name(function() {
  return axisFormat;
}, "getAxisFormat");
var setTickInterval = /* @__PURE__ */ index.__name(function(txt) {
  tickInterval = txt;
}, "setTickInterval");
var getTickInterval = /* @__PURE__ */ index.__name(function() {
  return tickInterval;
}, "getTickInterval");
var setTodayMarker = /* @__PURE__ */ index.__name(function(txt) {
  todayMarker = txt;
}, "setTodayMarker");
var getTodayMarker = /* @__PURE__ */ index.__name(function() {
  return todayMarker;
}, "getTodayMarker");
var setDateFormat = /* @__PURE__ */ index.__name(function(txt) {
  dateFormat = txt;
}, "setDateFormat");
var enableInclusiveEndDates = /* @__PURE__ */ index.__name(function() {
  inclusiveEndDates = true;
}, "enableInclusiveEndDates");
var endDatesAreInclusive = /* @__PURE__ */ index.__name(function() {
  return inclusiveEndDates;
}, "endDatesAreInclusive");
var enableTopAxis = /* @__PURE__ */ index.__name(function() {
  topAxis = true;
}, "enableTopAxis");
var topAxisEnabled = /* @__PURE__ */ index.__name(function() {
  return topAxis;
}, "topAxisEnabled");
var setDisplayMode = /* @__PURE__ */ index.__name(function(txt) {
  displayMode = txt;
}, "setDisplayMode");
var getDisplayMode = /* @__PURE__ */ index.__name(function() {
  return displayMode;
}, "getDisplayMode");
var getDateFormat = /* @__PURE__ */ index.__name(function() {
  return dateFormat;
}, "getDateFormat");
var setIncludes = /* @__PURE__ */ index.__name(function(txt) {
  includes = txt.toLowerCase().split(/[\s,]+/);
}, "setIncludes");
var getIncludes = /* @__PURE__ */ index.__name(function() {
  return includes;
}, "getIncludes");
var setExcludes = /* @__PURE__ */ index.__name(function(txt) {
  excludes = txt.toLowerCase().split(/[\s,]+/);
}, "setExcludes");
var getExcludes = /* @__PURE__ */ index.__name(function() {
  return excludes;
}, "getExcludes");
var getLinks = /* @__PURE__ */ index.__name(function() {
  return links;
}, "getLinks");
...
var isInvalidDate = /* @__PURE__ */ index.__name(function(date, dateFormat2, excludes2, includes2) {
...
var setWeekday = /* @__PURE__ */ index.__name(function(txt) {
  weekday = txt;
}, "setWeekday");
var getWeekday = /* @__PURE__ */ index.__name(function() {
  return weekday;
}, "getWeekday");
var setWeekend = /* @__PURE__ */ index.__name(function(startDay) {
  weekend = startDay;
}, "setWeekend");
var checkTaskDates = /* @__PURE__ */ index.__name(function(task, dateFormat2, excludes2, includes2) {
  if (!excludes2.length || task.manualEndTime) {
    return;
  }
  let startTime;
  if (task.startTime instanceof Date) {
    startTime = index.dayjs2(task.startTime);
  } else {
    startTime = index.dayjs2(task.startTime, dateFormat2, true);
  }
  startTime = startTime.add(1, "d");
  let originalEndTime;
  if (task.endTime instanceof Date) {
    originalEndTime = index.dayjs2(task.endTime);
  } else {
    originalEndTime = index.dayjs2(task.endTime, dateFormat2, true);
  }
...
var fixTaskDates = /* @__PURE__ */ index.__name(function(startTime, endTime, dateFormat2, excludes2, includes2) {
  let invalid = false;
...
var getStartDate = /* @__PURE__ */ index.__name(function(prevTime, dateFormat2, str) {
  str = str.trim();
  const isTimestampFormat = /* @__PURE__ */ index.__name((format) => {
  ...
  let mDate = index.dayjs2(str, dateFormat2.trim(), true);
  if (mDate.isValid()) {
    return mDate.toDate();
  } else {
    index.log.debug("Invalid date:" + str);
    index.log.debug("With date format:" + dateFormat2.trim());
...
var parseDuration = /* @__PURE__ */ index.__name(function(str) {
...
var getEndDate = /* @__PURE__ */ index.__name(function(prevTime, dateFormat2, str, inclusive = false) {
  str = str.trim();
  ...
  let parsedDate = index.dayjs2(str, dateFormat2.trim(), true);
  ...
  let endTime = index.dayjs2(prevTime);
...
var taskCnt = 0;
var parseId = /* @__PURE__ */ index.__name(function(idStr) {
  if (idStr === void 0) {
    taskCnt = taskCnt + 1;
    return "task" + taskCnt;
  }
...
var compileData = /* @__PURE__ */ index.__name(function(prevTask, dataStr) {
  let ds;
  ...
  if (endTimeData) {
    ...
    task.manualEndTime = index.dayjs2(endTimeData, "YYYY-MM-DD", true).isValid();
    checkTaskDates(task, dateFormat, excludes, includes);
  }
  return task;
}, "compileData");
var parseData = /* @__PURE__ */ index.__name(function(prevTaskId, dataStr) {
  let ds;
  if (dataStr.substr(0, 1) === ":") {
    ds = dataStr.substr(1, dataStr.length);
  } else {
...
var rawTasks = [];
var taskDb = {};
var addTask = /* @__PURE__ */ index.__name(function(descr, data) {
  const rawTask = {
...
var findTaskById = /* @__PURE__ */ index.__name(function(id) {
  const pos = taskDb[id];
  return rawTasks[pos];
}, "findTaskById");
var addTaskOrg = /* @__PURE__ */ index.__name(function(descr, data) {
  const newTask = {
    section: currentSection,
    type: currentSection,
    description: descr,
  ...
  const compileTask = /* @__PURE__ */ index.__name(function(pos) {
    ...
    if (rawTasks[pos].startTime) {
      ...
      if (rawTasks[pos].endTime) {
        ...
        rawTasks[pos].manualEndTime = index.dayjs2(
          rawTasks[pos].raw.endTime.data,
          "YYYY-MM-DD",
          true
        ).isValid();
...
var setLink = /* @__PURE__ */ index.__name(function(ids, _linkStr) {
  let linkStr = _linkStr;
  if (index.getConfig2().securityLevel !== "loose") {
...
var setClass = /* @__PURE__ */ index.__name(function(ids, className) {
  ids.split(",").forEach(function(id) {
    let rawTask = findTaskById(id);
    if (rawTask !== void 0) {
...
var setClickFun = /* @__PURE__ */ index.__name(function(id, functionName, functionArgs) {
  if (index.getConfig2().securityLevel !== "loose") {
    return;
  }
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      index.utils_default.runFunc(functionName, ...argList);
    });
  }
}, "setClickFun");
var pushFun = /* @__PURE__ */ index.__name(function(id, callbackFunction) {
  funs.push(
    function() {
...
var setClickEvent = /* @__PURE__ */ index.__name(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
    setClickFun(id, functionName, functionArgs);
  });
  setClass(ids, "clickable");
}, "setClickEvent");
var bindFunctions = /* @__PURE__ */ index.__name(function(element) {
  funs.forEach(function(fun) {
    fun(element);
  });
}, "bindFunctions");
var ganttDb_default = {
  getConfig: /* @__PURE__ */ index.__name(() => index.getConfig2().gantt, "getConfig"),
  clear: clear2,
  setDateFormat,
  getDateFormat,
  enableInclusiveEndDates,
...
index.__name(getTaskTags, "getTaskTags");
index.dayjs2.extend(dayjsDuration);
var setConf = /* @__PURE__ */ index.__name(function() {
  index.log.debug("Something is calling, setConf, remove the call");
}, "setConf");
...
var getMaxIntersections = /* @__PURE__ */ index.__name((tasks2, orderOffset) => {
...
var draw = /* @__PURE__ */ index.__name(function(text, id, version, diagObj) {
  const conf = index.getConfig2().gantt;
  ...
  index.__name(taskCompare, "taskCompare");
  ...
  index.__name(makeGantt, "makeGantt");
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = index.getConfig2().securityLevel;
  ...
  index.__name(drawRects, "drawRects");
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (index.dayjs2(maxTime).diff(index.dayjs2(minTime), "year") > 5) {
      index.log.warn(
  ...
  index.__name(drawExcludeDays, "drawExcludeDays");
  function getEstimatedTickCount(minTime, maxTime, every, interval) {
    if (every <= 0 || minTime > maxTime) {
      return Infinity;
    }
    const timeDiffMs = maxTime - minTime;
    const intervalMs = index.dayjs2.duration({ [interval ?? "day"]: every }).asMilliseconds();
    if (intervalMs <= 0) {
      return Infinity;
    }
    return Math.ceil(timeDiffMs / intervalMs);
  }
  index.__name(getEstimatedTickCount, "getEstimatedTickCount");
  ...
  index.__name(vertLabels, "vertLabels");
  ...
  index.__name(drawToday, "drawToday");
  ...
  index.__name(checkUnique, "checkUnique");
}, "draw");
...
//# sourceMappingURL=ganttDiagram-6RSMTGT7-Cph5kEwr.cjs.map
