              ...
              reader.onload = () => {
                try {
                  ...
                  if (parsed && typeof parsed === 'object') {
                    ...
                    console.error('Invalid hanzogui config structure')
                  }
                } catch (error) {
                  console.error('Failed to parse hanzogui config:', error)
                }
              }
              ...
              <YStack gap="$4">
                ...
                {!config.storageItem && (
                  <>
                    <Paragraph size="$4">
                      Drag and drop your{' '}
                      <CodeInline>.hanzogui/hanzogui.config.json</CodeInline> here to
                    ...
                    <Features
                      items={[
                        <React.Fragment key="">
                          Create a <CodeInline>hanzogui.build.ts</CodeInline> at the root
