...
const MISSING_COMPONENTS: Omit<ComponentSchema, 'isOSS'>[] = [
  ...
  },
  {
    ...
    dependencies: ['@hanzogui/lucide-icons-2'],
  ...
  },
  {
    ...
    category: 'forms',
    categorySection: 'inputs',
    dependencies: ['react-hook-form', '@hanzogui/lucide-icons-2'],
    moveFilesToFolder: [
...
export const componentsList: ComponentSchema[] = [
  ...
  },
  {
    ...
    dependencies: ['@ngneat/falso', '@hanzogui/lucide-icons-2'],
    moveFilesToFolder: [
      { file: 'Fullpage', to: '' },
  ...
  },
  {
    ...
    dependencies: ['@hanzogui/get-font-sized'],
    moveFilesToFolder: [
      { file: 'Chips', to: '' },
  ...
  },
  {
    ...
    dependencies: ['@ngneat/falso', '@hanzogui/web'],
  ...
  },
  {
    ...
    dependencies: ['@hanzogui/lucide-icons-2', '@hanzogui/roving-focus'],
    moveFilesToFolder: [
  ...
  },
  {
    ...
    dependencies: ['@hanzogui/lucide-icons-2', '@hanzogui/core'],
    moveFilesToFolder: [
  ...
  },
  {
    ...
    category: 'user',
    categorySection: 'preferences',
    dependencies: ['@hanzogui/lucide-icons-2', '@hanzogui/get-font-sized'],
