...
var init_themeInfo = __esm({
  "../../core/create-theme/dist/esm/themeInfo.mjs"() {
    ...
    getThemeInfo = /* @__PURE__ */ __name((theme, name) => THEME_INFO.get(name || JSON.stringify(theme)), "getThemeInfo");
...
var init_masks = __esm({
  "../../core/create-theme/dist/esm/masks.mjs"() {
    createMask = /* @__PURE__ */ __name((createMask2) => typeof createMask2 == "function" ? {
...
var import_web, colorTokens, lightShadowColor, lightShadowColorStrong, darkShadowColor, darkShadowColorStrong, darkColors, lightColors, color, defaultPalettes, getTemplates, defaultTemplates, shadows, nonInherited, overlayThemeDefinitions, inverseSurface1, surface1, surface2, surface3, defaultComponentThemes, defaultSubThemes, themeBuilder, themesIn, themes, tokens2;
...
var import_web2, import_react2, EXTRACT_MS_REGEX, EXTRACT_S_REGEX, MS_DURATION_REGEX, S_DURATION_REGEX, TRANSFORM_KEYS;
...
var init_esm7 = __esm({
  "../../core/font-geist-sans/dist/esm/index.mjs"() {
    ...
    createGeistSansFont = /* @__PURE__ */ __name((font = {}, {
      ...
      return (0, import_core.createFont)({
        family: import_core.isWeb ? '"Geist Sans", "Geist", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' : "Geist",
...
var init_esm8 = __esm({
  "../../core/font-geist-mono/dist/esm/index.mjs"() {
    ...
    createGeistMonoFont = /* @__PURE__ */ __name((font = {}, {
      sizeLineHeight = /* @__PURE__ */ __name((size2) => Math.round(size2 * 1.5), "sizeLineHeight"),
      sizeSize = /* @__PURE__ */ __name((size2) => size2 * 1, "sizeSize")
    } = {}) => {
      const size2 = Object.fromEntries(Object.entries({
      ...
      return (0, import_core2.createFont)({
        family: import_core2.isWeb ? '"Geist Mono", "SF Mono", "Fira Code", "Fira Mono", "Roboto Mono", monospace' : "GeistMono",
...
var init_fonts = __esm({
  "../../core/config/dist/esm/fonts.mjs"() {
    ...
    headingFont = createGeistSansFont({
      ...
      sizeLineHeight: /* @__PURE__ */ __name((size2) => Math.round(size2 * 1.1 + (size2 < 30 ? 10 : 5)), "sizeLineHeight")
    });
    bodyFont = createGeistSansFont({
      ...
      sizeLineHeight: /* @__PURE__ */ __name((size2) => Math.round(size2 * 1.1 + (size2 >= 12 ? 8 : 4)), "sizeLineHeight")
    });
    monoFont = createGeistMonoFont({
      ...
      sizeLineHeight: /* @__PURE__ */ __name((x) => Math.round(x * 1.5), "sizeLineHeight")
    });
    fonts = {
      heading: headingFont,
      body: bodyFont,
