...
description: Why Gui uses an optimizing compiler
---
...
second one [Gui UI](/docs/components/stacks) is working towards slowly.
...
objects, and hooks. The Gui Compiler does this using partial evaluation,
static extraction and hoisting, code elimination, and tree-flattening.

You can
[skip to the technical details without the backstory](#how-hanzogui-helps) from
here if you'd like.
...
Gui makes React faster, but mostly makes _making_ React faster.

Give Gui a try with `npm create hanzogui@latest`.
