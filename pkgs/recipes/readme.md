...
// Anonymous read path (used by gui-get CLI, website, IDE extensions)
...
```ts
import { authAdmin, ensureCollection, upsertRecipe } from '@hanzo/recipes'
...
```ts
import { findProjectRoot, readConfig, resolveInstallDir } from '@hanzo/recipes'
