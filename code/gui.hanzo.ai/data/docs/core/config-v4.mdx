---
title: Quick Config
description: Easy config and themes with @hanzo/gui-config/v4
---
...
apps, we recommend our `@hanzo/gui-config` package.
...
import { createThemes, defaultComponentThemes } from '@hanzo/gui-config/v4'
