...
[Source code for SizableText](https://github.com/hanzogui/hanzogui/blob/main/pkgs/ui/text/src/SizableText.tsx).
...
```tsx
import { Text, SizableText, Paragraph } from 'hanzogui'
