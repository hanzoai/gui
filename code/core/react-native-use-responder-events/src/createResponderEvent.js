...
exports.createResponderEvent = createResponderEvent;
...
function createResponderEvent(domEvent, responderTouchHistoryStore) {
    ...
    var preventDefault = typeof domEvent.preventDefault === 'function'
    ...
    function locationX(x) {
        rect = rect || (0, utils_1.getBoundingClientRect)(responderEvent.currentTarget);
        if (rect) {
            return x - rect.left;
        }
    }
