...
[Seeing how SizableText is defined](https://github.com/hanzoai/gui/blob/v2/pkgs/ui/text/src/SizableText.tsx) is helpful for understanding Gui. They serve as a good example of how you can extend and compose components.
