...
function useAnimateSSRSafe() {
  return isServer2 ? [useRef(null), () => {}] : useAnimate()
}
...
function createAnimations2(animations2) {
  ...
  return {
    ...
    useAnimations: /* @__PURE__ */ __name((animationProps) => {
      isHydratingGlobal === void 0 &&
        !getConfig().settings.disableSSR &&
        (isHydratingGlobal = true)
      const { props, style, componentState, stateRef, useStyleEmitter, presence } =
          animationProps,
        animationKey = Array.isArray(props.transition)
          ? props.transition[0]
          : props.transition,
        isComponentHydrating = componentState.unmounted === true,
            ...
            if (
              ...
              process.env.NODE_ENV === 'development' &&
                ...
                (console.groupCollapsed(
                  `[motion] animate (${JSON.stringify(getDiff(refs.current.lastDoAnimate, doAnimate2), null, 2)})`
                ),
                console.info({
                  props,
                  componentState,
            ...
            if (doAnimate2) {
              ...
              if (diff) {
                ...
                if (refs.current.controls) {
                  ...
                  if (
                    (isCurrentlyExiting && refs.current.controls.stop(), midFlightValues)
                  )
        ...
        useIsomorphicLayoutEffect2(() => {
          if (refs.current.isFirstRender) {
            if (((refs.current.isFirstRender = false), isHydrating)) {
              ;(doAnimate && Object.keys(doAnimate).length > 0
                ? (refs.current.lastDoAnimate = {
                    ...doAnimate,
                  })
    ...
    useAnimatedNumberStyle(val, getStyleProp) {
      ...
      return (
        ...
        useMemo(
          () => ({
            getStyle: /* @__PURE__ */ __name(
              (cur) => getStyleRef.current(cur),
              'getStyle'
            ),
            motionValue,
          }),
  ...
  function getMotionAnimatedProps(
    ...
    for (const key in style) {
      ...
      disableAnimationProps.has(key) || (animateOnly && !animateOnly.includes(key))
        ? ((dontAnimate ||= {}), (dontAnimate[key] = value))
        : ((doAnimate ||= {}), (doAnimate[key] = value))
    }
    return {
      dontAnimate,
      doAnimate,
  ...
  function getAnimationOptions(transitionProp, animationState = 'default') {
    ...
    if (
      ...
      return {}
    const defaultConfig2 = effectiveKey
        ? withInferredType(animations2[effectiveKey])
        : null,
      delay = normalized.delay,
      result = {}
    ;(defaultConfig2 && Object.assign(result, defaultConfig2),
      globalConfigOverride &&
        (Object.assign(result, globalConfigOverride),
        result.type === void 0 &&
          result.duration !== void 0 &&
          result.damping === void 0 &&
          result.stiffness === void 0 &&
          result.mass === void 0 &&
          (result.type = 'tween')),
      delay && (result.delay = delay),
      (defaultConfig2 || globalConfigOverride || delay) &&
        (result.default = {
          ...defaultConfig2,
          ...globalConfigOverride,
          ...(delay
    ...
    for (const [propName, animationNameOrConfig] of Object.entries(normalized.properties))
      if (typeof animationNameOrConfig == 'string')
        ...
        const baseConfig = animationNameOrConfig.type
          ? withInferredType(animations2[animationNameOrConfig.type])
          : defaultConfig2
        result[propName] = {
          ...baseConfig,
    ...
    for (const key in result)
      key !== 'default' && typeof result[key] == 'object' && convertMsToS(result[key])
    return result
  }
  ...
  return config2
    ? {
        type:
          ...
          config2.damping === void 0 &&
          config2.stiffness === void 0 &&
          config2.mass === void 0
            ? 'tween'
            : 'spring',
        ...config2,
...
function convertMsToS(config2) {
  config2 &&
    (typeof config2.delay == 'number' && (config2.delay = config2.delay / 1e3),
    typeof config2.duration == 'number' &&
      (config2.type === 'tween' ||
        (config2.type === void 0 &&
          config2.damping === void 0 &&
          config2.stiffness === void 0 &&
  ...
  const isText = defaultTag === 'span',
    Component = forwardRef((propsIn, ref) => {
      ...
      function getProps(props2) {
        ...
        return out
          ? (out.viewProps.style &&
              (fixStyles(out.viewProps.style), styleToCSS(out.viewProps.style)),
            out.viewProps)
          : {}
      }
      ...
      const props = getProps({
        ...
        Element = render || 'div',
        transformedProps = hooks.usePropsTransform?.(render, props, stateRef, false)
      return (
        useEffect3(() => {
          if (animatedStyle)
  ...
  ({
    ...
    return createFont({
      ...
      lineHeight: Object.fromEntries(
        Object.entries(size3).map(([k, v]) => [k, sizeLineHeight(getVariableValue(v))])
      ),
      weight: {
        1: '400',
      },
...
var headingLineHeight = /* @__PURE__ */ __name(
  (size3) => Math.round(isNative ? size3 * 1.2 : size3 * 1.12 + 5),
  'headingLineHeight'
)
var fonts = {
...
import {
  createFont as createFont2,
  getVariableValue as getVariableValue2,
} from '@hanzogui/core'
var createCherryBombFont = /* @__PURE__ */ __name(
  (
    font = {},
    {
    ...
    return createFont2({
      ...
      lineHeight: Object.fromEntries(
        Object.entries(size3).map(([k, v]) => [
          k,
          Math.round(sizeLineHeight(getVariableValue2(v))),
        ])
      ),
      weight: {
        4: '300',
  ...
  (
    ...
    return createFont3({
      family: isWeb3
        ...
        : 'Inter',
      lineHeight: Object.fromEntries(
        Object.entries(size3).map(([k, v]) => [k, sizeLineHeight(getVariableValue3(v))])
      ),
      weight: {
        4: '300',
      },
...
var bodyFont = createInterFont(
  ...
  },
  {
    sizeSize: /* @__PURE__ */ __name((size3) => Math.round(size3), 'sizeSize'),
    sizeLineHeight: /* @__PURE__ */ __name(
      (size3) => Math.round(size3 * 1.2 + (size3 >= 20 ? 12 : 8)),
      'sizeLineHeight'
    ),
  }
)
