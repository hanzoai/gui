...
exports.UIManager = {
    ...
    focus: function (node) {
        try {
            ...
            if (node.getAttribute('tabIndex') == null && focusableElements[name_1] == null) {
    ...
    measure: function (node, callback) {
        return (0, use_element_layout_1.measure)(node, callback);
    },
    measureInWindow: function (node, callback) {
        return (0, use_element_layout_1.measureInWindow)(node, callback);
    },
    ...
    measureLayout: function (node, relativeToNativeNode, onFail, onSuccess) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, measureLayout(node, relativeToNativeNode, onSuccess)];
            });
        });
    },
