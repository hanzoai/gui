...
var isAndroid =
  process.env.TEST_NATIVE_PLATFORM === 'android' || // Android TV has Platform.OS === 'android' per react-native-tvos
  process.env.TEST_NATIVE_PLATFORM === 'androidtv'
var isIos =
  process.env.TEST_NATIVE_PLATFORM === 'ios' || // tvOS has Platform.OS === 'ios' per react-native-tvos
      ...
      return useMemo(() => {
        return {
          getStyle: /* @__PURE__ */ __name(
            (...currentValues) => getStyleRef.current(...currentValues),
            'getStyle'
          ),
          motionValues,
        }
