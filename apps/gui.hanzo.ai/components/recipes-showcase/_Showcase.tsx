...
// @ts-ignore - recipes component wildcard import
import { useCurrentRouteParams } from '@hanzogui/recipes'
// @ts-ignore - recipes component wildcard import
import { useGroupMedia } from '@hanzogui/recipes/component/hooks/useGroupMedia'
import { CodeWindow } from './CodeWindow'
// import { ThemeButton } from './ThemeButton'
import { authFetch } from '~/features/api/authFetch'
import { useRecipesShowcase } from './RecipesProvider'
...
const ShowcaseView = forwardRef<any, Props>(
  (
    ...
    const { showAppropriateModal, isProUser } = useRecipesShowcase('RecipesShowcase')

    // @ts-expect-error - URLSearchParams type mismatch with object
    const codePath = `/api/recipes/code?${new URLSearchParams({
      section,
      part,
      fileName,
    })}`
            ...
            {view === 'preview' ? (
              ...
              <YStack gap="$4" items="center">
                ...
                <Text
                  ...
                  fontFamily="$mono"
                >
                  Purchase the Recipes package to access the code.
                </Text>
