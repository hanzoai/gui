...
The package `tamagui` is a superset of `@hanzo/gui-core`, so if you've already installed core you can change all the references to `tamagui`.
...
```tsx
import { createTamagui, TamaguiProvider, View } from '@hanzo/gui'
