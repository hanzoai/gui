...
Switch is already installed in `hanzogui`, or you can install it independently:
...
```tsx
import { Switch } from 'hanzogui' // or '@hanzogui/switch'
...
`Switch` extends Stack views inheriting all the [Gui standard props](/docs/intro/props), plus:
...
`Switch.Thumb` extends Stack views inheriting all the [Gui standard props](/docs/intro/props), plus:
