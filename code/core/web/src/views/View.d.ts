import type { StackNonStyleProps, StackStyle, StackStyleBase, HanzoguiElement } from '../types';
...
export declare const View: import("../types").HanzoguiComponent<ViewProps, HanzoguiElement, StackNonStyleProps, StackStyleBase, {}>;
