  ...
  ({
    ...
    return createFont({
      ...
      lineHeight: Object.fromEntries(
        Object.entries(size2).map(([k, v]) => [k, sizeLineHeight(getVariableValue(v))])
      ),
      weight: {
        1: '400',
      },
...
var headingLineHeight = /* @__PURE__ */ __name(
  (size2) => Math.round(isNative ? size2 * 1.2 : size2 * 1.12 + 5),
  'headingLineHeight'
)
var fonts = {
...
function createAnimations(animations) {
  ...
  function getAnimationOptions(transitionProp, animationState = 'default') {
    ...
    const defaultConfig2 = effectiveKey
        ? withInferredType(animations[effectiveKey])
        : null,
...
export { config, gui_config_default as default }
