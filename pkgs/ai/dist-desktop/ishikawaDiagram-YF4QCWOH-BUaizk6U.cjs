...
var IshikawaDB = class {
  ...
  addNode(rawLevel, text) {
    const label = index.common_default.sanitizeText(text, index.getConfig2());
    if (!this.root) {
      this.root = { text: label, children: [] };
      this.stack = [{ level: 0, node: this.root }];
      index.setDiagramTitle(label);
      return;
    }
  ...
  getAccTitle() {
    return index.getAccTitle();
  }
  setAccTitle(title) {
    index.setAccTitle(title);
  }
  getAccDescription() {
    return index.getAccDescription();
  }
  setAccDescription(description) {
    index.setAccDescription(description);
  }
  getDiagramTitle() {
    return index.getDiagramTitle();
  }
  setDiagramTitle(title) {
    index.setDiagramTitle(title);
  }
};
...
var applyPaddedViewBox = /* @__PURE__ */ index.__name((svgEl, pad, maxW) => {
  const bbox = svgEl.node().getBBox();
  const w = bbox.width + pad * 2;
  const h = bbox.height + pad * 2;
  index.configureSvgSize(svgEl, h, w, maxW);
...
var draw = /* @__PURE__ */ index.__name((_text, id, _version, diagram2) => {
  ...
  const drawConfig = index.getConfig2();
  const { look, handDrawnSeed, themeVariables } = drawConfig;
  const fontSize = index.parseFontSize(drawConfig.fontSize)[0] ?? FONT_SIZE_DEFAULT;
  ...
  const roughSvg = isHandDrawn ? index.at.svg(svg.node()) : void 0;
...
var sideStats = /* @__PURE__ */ index.__name((nodes) => {
  const countDescendants = /* @__PURE__ */ index.__name((node) => node.children.reduce((sum, child) => sum + 1 + countDescendants(child), 0), "countDescendants");
  return nodes.reduce(
    (stats, node) => {
...
var drawHead = /* @__PURE__ */ index.__name((svg, x, y, label, fontSize, roughContext) => {
...
var flattenTree = /* @__PURE__ */ index.__name((children, direction) => {
  const entries = [];
  const yOrder = [];
  const walk = /* @__PURE__ */ index.__name((nodes, pid, depth) => {
...
var drawCauseLabel = /* @__PURE__ */ index.__name((svg, text, x, y, direction, fontSize, roughContext) => {
...
var drawArrowMarker = /* @__PURE__ */ index.__name((g, x, y, dx, dy, roughContext) => {
...
var drawBranch = /* @__PURE__ */ index.__name((svg, node, startX, startY, direction, length, fontSize, roughContext) => {
...
var splitLines = /* @__PURE__ */ index.__name((text) => text.split(/<br\s*\/?>|\n/), "splitLines");
var wrapText = /* @__PURE__ */ index.__name((text, maxChars) => {
...
var drawMultilineText = /* @__PURE__ */ index.__name((g, text, x, y, cls, anchor, fontSize) => {
...
var lerp = /* @__PURE__ */ index.__name((a, b, t) => a + (b - a) * t, "lerp");
var drawLine = /* @__PURE__ */ index.__name((g, x1, y1, x2, y2, cls, roughContext) => {
  if (roughContext) {
...
//# sourceMappingURL=ishikawaDiagram-YF4QCWOH-BUaizk6U.cjs.map
