...
Gui also provides a few types of other variant definition patterns that work
...
Variants have the full power of the Gui styling system, including pseudo and
media styles:
