...
FocusScope is already installed in `hanzogui`, or you can install it
independently:
...
```tsx
import { Button, FocusScope, XStack } from 'hanzogui'
...
```tsx
import { Button, Dialog, FocusScope, XStack, YStack } from 'hanzogui'
...
```tsx
import { Button, FocusScope, XStack, YStack } from 'hanzogui'
...
```tsx
import { FocusScope, View } from 'hanzogui'
...
Many Gui components export FocusScope for advanced focus control:

```tsx
import { Dialog, Popover, Select } from 'hanzogui'
...
```tsx
import { Button, Dialog, FocusScope, Input, XStack, YStack } from 'hanzogui'
...
```tsx
import { Button, FocusScope, styled, XStack } from 'hanzogui'
