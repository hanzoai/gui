...
var SankeyLink = class {
  ...
  static {
    index.__name(this, "SankeyLink");
  }
};
var addLink = /* @__PURE__ */ index.__name((source, target, value) => {
...
var SankeyNode = class {
  ...
  static {
    index.__name(this, "SankeyNode");
  }
};
var findOrCreateNode = /* @__PURE__ */ index.__name((ID) => {
  ID = index.common_default.sanitizeText(ID, index.getConfig2());
...
var getNodes = /* @__PURE__ */ index.__name(() => nodes, "getNodes");
var getLinks = /* @__PURE__ */ index.__name(() => links, "getLinks");
var getGraph = /* @__PURE__ */ index.__name(() => ({
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */ index.__name(() => index.getConfig2().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
var findCentralNodeLayer = /* @__PURE__ */ index.__name((nodes2) => {
  let maxValue = 0;
  let centralLayer = 0;
...
var draw = /* @__PURE__ */ index.__name(function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = index.getConfig2();
  const defaultSankeyConfig = index.defaultConfig2.sankey;
  let sandboxElement;
  ...
  const colorScheme = ordinal.ordinal(d3schemeTableau10);
  const getNodeColor = /* @__PURE__ */ index.__name((nodeId) => {
  ...
  const getText = /* @__PURE__ */ index.__name(({ id: id2, value }) => {
    if (!showValues) {
      return id2;
    }
    return `${id2}
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  const getLabelPosition = /* @__PURE__ */ index.__name((d) => {
  ...
  const appendLabel = /* @__PURE__ */ index.__name((className) => labelsGroup.selectAll(className ? `.${className}` : "text").data(graph.nodes).join("text").attr("class", className ?? null).attr("x", (d) => getLabelPosition(d).x).attr("y", (d) => (d.y1 + d.y0) / 2).attr("dy", `${showValues ? "0" : "0.35"}em`).attr("text-anchor", (d) => getLabelPosition(d).anchor).text(getText), "appendLabel");
  if (labelStyle === "outlined") {
  ...
  switch (linkColor) {
    case "gradient":
      coloring = /* @__PURE__ */ index.__name((d) => d.uid, "coloring");
      break;
    case "source":
      coloring = /* @__PURE__ */ index.__name((d) => getNodeColor(d.source.id), "coloring");
      break;
    case "target":
      coloring = /* @__PURE__ */ index.__name((d) => getNodeColor(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
  link.append("path").attr("d", d3SankeyLinkHorizontal()).attr("stroke", coloring).attr("stroke-width", (d) => Math.max(1, d.width));
  index.setupGraphViewbox(void 0, svg, 0, useMaxWidth);
}, "draw");
...
var prepareTextForParsing = /* @__PURE__ */ index.__name((text) => {
...
//# sourceMappingURL=sankeyDiagram-5OEKKPKP-tKSXyI5O.cjs.map
