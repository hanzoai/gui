...
[![npm](https://img.shields.io/npm/v/@hanzogui/lucide-icons-2.svg)](https://www.npmjs.com/package/@hanzogui/lucide-icons-2)
...
### Installation
    ...
    npm install @hanzogui/lucide-icons-2 --save
...
```javascript
import { Camera } from '@hanzogui/lucide-icons-2'
...
```javascript
import Camera from '@hanzogui/lucide-icons-2/dist/icons/camera'
...
```javascript
var Camera = require('@hanzogui/lucide-icons-2/dist/icons/camera').default
...
```javascript
import * as Icon from '@hanzogui/lucide-icons-2'
