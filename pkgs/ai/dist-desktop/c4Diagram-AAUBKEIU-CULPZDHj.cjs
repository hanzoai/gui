...
const chunkND2GUHAM = require('./chunk-ND2GUHAM-B5Kif-rg.cjs');
...
var c4Type;
var getC4Type = /* @__PURE__ */ index.__name(function() {
  return c4Type;
}, "getC4Type");
var setC4Type = /* @__PURE__ */ index.__name(function(c4TypeParam) {
  let sanitizedText = index.sanitizeText(c4TypeParam, index.getConfig2());
  c4Type = sanitizedText;
}, "setC4Type");
var addRel = /* @__PURE__ */ index.__name(function(type, from, to, label, techn, descr, sprite, tags, link) {
...
var addPersonOrSystem = /* @__PURE__ */ index.__name(function(typeC4Shape, alias, label, descr, sprite, tags, link) {
...
var addContainer = /* @__PURE__ */ index.__name(function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let container = {};
...
var addComponent = /* @__PURE__ */ index.__name(function(typeC4Shape, alias, label, techn, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let component = {};
...
var addPersonOrSystemBoundary = /* @__PURE__ */ index.__name(function(alias, label, type, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addContainerBoundary = /* @__PURE__ */ index.__name(function(alias, label, type, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var addDeploymentNode = /* @__PURE__ */ index.__name(function(nodeType, alias, label, type, descr, sprite, tags, link) {
  if (alias === null || label === null) {
    return;
  }
  let boundary = {};
...
var popBoundaryParseStack = /* @__PURE__ */ index.__name(function() {
  currentBoundaryParse = parentBoundaryParse;
  boundaryParseStack.pop();
  parentBoundaryParse = boundaryParseStack.pop();
  boundaryParseStack.push(parentBoundaryParse);
}, "popBoundaryParseStack");
var updateElStyle = /* @__PURE__ */ index.__name(function(typeC4Shape, elementName, bgColor, fontColor, borderColor, shadowing, shape, sprite, techn, legendText, legendSprite) {
...
var updateRelStyle = /* @__PURE__ */ index.__name(function(typeC4Shape, from, to, textColor, lineColor, offsetX, offsetY) {
...
var updateLayoutConfig = /* @__PURE__ */ index.__name(function(typeC4Shape, c4ShapeInRowParam, c4BoundaryInRowParam) {
...
var getC4ShapeInRow = /* @__PURE__ */ index.__name(function() {
  return c4ShapeInRow;
}, "getC4ShapeInRow");
var getC4BoundaryInRow = /* @__PURE__ */ index.__name(function() {
  return c4BoundaryInRow;
}, "getC4BoundaryInRow");
var getCurrentBoundaryParse = /* @__PURE__ */ index.__name(function() {
  return currentBoundaryParse;
}, "getCurrentBoundaryParse");
var getParentBoundaryParse = /* @__PURE__ */ index.__name(function() {
  return parentBoundaryParse;
}, "getParentBoundaryParse");
var getC4ShapeArray = /* @__PURE__ */ index.__name(function(parentBoundary) {
...
var getC4Shape = /* @__PURE__ */ index.__name(function(alias) {
  return c4ShapeArray.find((personOrSystem) => personOrSystem.alias === alias);
}, "getC4Shape");
var getC4ShapeKeys = /* @__PURE__ */ index.__name(function(parentBoundary) {
  return Object.keys(getC4ShapeArray(parentBoundary));
}, "getC4ShapeKeys");
var getBoundaries = /* @__PURE__ */ index.__name(function(parentBoundary) {
  if (parentBoundary === void 0 || parentBoundary === null) {
    return boundaries;
  } else {
...
var getRels = /* @__PURE__ */ index.__name(function() {
  return rels;
}, "getRels");
var getTitle = /* @__PURE__ */ index.__name(function() {
  return title;
}, "getTitle");
var setWrap = /* @__PURE__ */ index.__name(function(wrapSetting) {
  wrapEnabled = wrapSetting;
}, "setWrap");
var autoWrap = /* @__PURE__ */ index.__name(function() {
  return wrapEnabled;
}, "autoWrap");
var clear = /* @__PURE__ */ index.__name(function() {
  c4ShapeArray = [];
  boundaries = [
    {
      alias: "global",
...
var setTitle = /* @__PURE__ */ index.__name(function(txt) {
  let sanitizedText = index.sanitizeText(txt, index.getConfig2());
  title = sanitizedText;
}, "setTitle");
var c4Db_default = {
  addPersonOrSystem,
  ...
  getConfig: /* @__PURE__ */ index.__name(() => index.getConfig2().c4, "getConfig"),
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
var drawRect2 = /* @__PURE__ */ index.__name(function(elem, rectData) {
  return chunkND2GUHAM.drawRect(elem, rectData);
}, "drawRect");
var drawImage = /* @__PURE__ */ index.__name(function(elem, width, height, x, y, link) {
...
var drawRels = /* @__PURE__ */ index.__name((elem, rels2, conf2, diagramId) => {
...
var drawBoundary = /* @__PURE__ */ index.__name(function(elem, boundary, conf2) {
...
var drawC4Shape = /* @__PURE__ */ index.__name(function(elem, c4Shape, conf2) {
  ...
  const rect = chunkND2GUHAM.getNoteRect();
  switch (c4Shape.typeC4Shape.text) {
    case "person":
    case "external_person":
    case "system":
...
var insertDatabaseIcon = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertComputerIcon = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertClockIcon = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertArrowHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertArrowEnd = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertArrowFilledHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertArrowCrossHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var getC4ShapeFont = /* @__PURE__ */ index.__name((cnf, typeC4Shape) => {
  return {
...
var c4ShapeFont = /* @__PURE__ */ index.__name((cnf, typeC4Shape) => {
  return {
    fontFamily: cnf[typeC4Shape + "FontFamily"],
    fontSize: cnf[typeC4Shape + "FontSize"],
    fontWeight: cnf[typeC4Shape + "FontWeight"]
...
var boundaryFont = /* @__PURE__ */ index.__name((cnf) => {
  return {
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      ...
      c4Shape[textType].textLines = c4Shape[textType].text.split(index.common_default.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = index.calculateTextHeight(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(index.common_default.lineBreakRegex);
...
index.__name(calcC4ShapeTextWH, "calcC4ShapeTextWH");
var drawBoundary2 = /* @__PURE__ */ index.__name(function(diagram2, boundary, bounds) {
...
var drawC4ShapeArray = /* @__PURE__ */ index.__name(function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  let Y = 0;
...
var getIntersectPoint = /* @__PURE__ */ index.__name(function(fromNode, endPoint) {
  let x1 = fromNode.x;
  let y1 = fromNode.y;
  let x2 = endPoint.x;
  let y2 = endPoint.y;
...
var getIntersectPoints = /* @__PURE__ */ index.__name(function(fromNode, endNode) {
...
var drawRels2 = /* @__PURE__ */ index.__name(function(diagram2, rels2, getC4ShapeObj, diagObj, diagramId) {
  let i = 0;
  for (let rel of rels2) {
    i = i + 1;
...
index.__name(drawInsideBoundary, "drawInsideBoundary");
var draw = /* @__PURE__ */ index.__name(function(_text, id, _version, diagObj) {
  conf = index.getConfig2().c4;
  ...
  index.log.debug(`C:${JSON.stringify(conf, null, 2)}`);
...
var getStyles = /* @__PURE__ */ index.__name((options) => `.person {
...
var diagram = {
  ...
  init: /* @__PURE__ */ index.__name(({ c4, wrap }) => {
...
//# sourceMappingURL=c4Diagram-AAUBKEIU-CULPZDHj.cjs.map
