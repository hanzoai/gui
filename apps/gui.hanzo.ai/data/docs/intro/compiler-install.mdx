...
Without it, you'd need to duplicate options across your metro, babel and vite
configs.
...
Next.js runs on Turbopack, which needs no plugin: create a `hanzogui.build.ts`
and run `hanzogui build` ahead of `next build`.
