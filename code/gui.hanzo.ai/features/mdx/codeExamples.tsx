export const animationCode = `import { Button, Square } from '@hanzo/gui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { Paragraph, View } from '@hanzo/gui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { View } from '@hanzo/gui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { useMedia, useTheme, View } from '@hanzo/gui'
...
import { View, useMedia, useTheme } from '@hanzo/gui'
