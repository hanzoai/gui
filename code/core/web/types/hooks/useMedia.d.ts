import type { ComponentContextI, DebugProp, GetStyleState, IsMediaType, HanzoguiInternalConfig, UseMediaState, WidthHeight } from '../types';
...
export declare const configureMedia: (config: HanzoguiInternalConfig) => void;
