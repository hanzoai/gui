---
title: Expo Guide
description: How to set up Gui with Expo
---
...
export const hanzoguiConfig = createGui(defaultConfig)
...
export default function RootLayout() {
  ...
  return (
    // add this
    <GuiProvider config={hanzoguiConfig} defaultTheme={colorScheme!}>
...
<InlineTabs id="font" defaultValue="hanzogui">
<InlineTabs.List>
    <InlineTabs.Tab value="hanzogui">Gui</InlineTabs.Tab>
    <InlineTabs.Tab value="expo">Expo Google Fonts</InlineTabs.Tab>
</InlineTabs.List>

<InlineTabs.Content value="hanzogui">
