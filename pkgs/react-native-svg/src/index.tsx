...
type Props = Record<string, unknown> & { testID?: string; accessibilityLabel?: string }
...
const svgElement = (tag: string) =>
  forwardRef<SVGElement, Props>((props, ref) =>
    createElement(tag, { ...toDOMProps(props), ref })
  )
