...
Only if you aren't not using `hanzogui` (but rather `@hanzogui/core`) you'll need to install the `@hanzogui/portal` package:
...
```tsx
import { Tooltip } from 'hanzogui' // or '@hanzogui/tooltip'
