...
const fcose = /*@__PURE__*/index.getDefaultExportFromCjs(cytoscapeFcoseExports);
...
var ArchitectureDirectionArrow = {
  L: /* @__PURE__ */ index.__name((scale) => `${scale},${scale / 2} 0,${scale} 0,0`, "L"),
  R: /* @__PURE__ */ index.__name((scale) => `0,${scale / 2} ${scale},0 ${scale},${scale}`, "R"),
  T: /* @__PURE__ */ index.__name((scale) => `0,0 ${scale},0 ${scale / 2},${scale}`, "T"),
  B: /* @__PURE__ */ index.__name((scale) => `${scale / 2},0 ${scale},${scale} 0,${scale}`, "B")
};
var ArchitectureDirectionArrowShift = {
  L: /* @__PURE__ */ index.__name((orig, arrowSize) => orig - arrowSize + 2, "L"),
  R: /* @__PURE__ */ index.__name((orig, _arrowSize) => orig - 2, "R"),
  T: /* @__PURE__ */ index.__name((orig, arrowSize) => orig - arrowSize + 2, "T"),
  B: /* @__PURE__ */ index.__name((orig, _arrowSize) => orig - 2, "B")
};
var getOppositeArchitectureDirection = /* @__PURE__ */ index.__name(function(x) {
...
var isArchitectureDirection = /* @__PURE__ */ index.__name(function(x) {
  const temp = x;
  return temp === "L" || temp === "R" || temp === "T" || temp === "B";
}, "isArchitectureDirection");
var isArchitectureDirectionX = /* @__PURE__ */ index.__name(function(x) {
  const temp = x;
  return temp === "L" || temp === "R";
}, "isArchitectureDirectionX");
var isArchitectureDirectionY = /* @__PURE__ */ index.__name(function(x) {
  const temp = x;
  return temp === "T" || temp === "B";
}, "isArchitectureDirectionY");
var isArchitectureDirectionXY = /* @__PURE__ */ index.__name(function(a, b) {
  const aX_bY = isArchitectureDirectionX(a) && isArchitectureDirectionY(b);
  const aY_bX = isArchitectureDirectionY(a) && isArchitectureDirectionX(b);
  return aX_bY || aY_bX;
}, "isArchitectureDirectionXY");
var isArchitecturePairXY = /* @__PURE__ */ index.__name(function(pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var isValidArchitectureDirectionPair = /* @__PURE__ */ index.__name(function(x) {
  return x !== "LL" && x !== "RR" && x !== "TT" && x !== "BB";
}, "isValidArchitectureDirectionPair");
var getArchitectureDirectionPair = /* @__PURE__ */ index.__name(function(sourceDir, targetDir) {
  const pair = `${sourceDir}${targetDir}`;
  return isValidArchitectureDirectionPair(pair) ? pair : void 0;
}, "getArchitectureDirectionPair");
var shiftPositionByArchitectureDirectionPair = /* @__PURE__ */ index.__name(function([x, y], pair) {
  const lhs = pair[0];
  const rhs = pair[1];
...
var getArchitectureDirectionXYFactors = /* @__PURE__ */ index.__name(function(pair) {
  if (pair === "LT" || pair === "TL") {
    return [1, 1];
...
var getArchitectureDirectionAlignment = /* @__PURE__ */ index.__name(function(a, b) {
...
var isArchitectureService = /* @__PURE__ */ index.__name(function(x) {
  const temp = x;
  return temp.type === "service";
}, "isArchitectureService");
var isArchitectureJunction = /* @__PURE__ */ index.__name(function(x) {
  const temp = x;
  return temp.type === "junction";
}, "isArchitectureJunction");
var edgeData = /* @__PURE__ */ index.__name((edge) => {
  return edge.data();
}, "edgeData");
var nodeData = /* @__PURE__ */ index.__name((node) => {
  return node.data();
}, "nodeData");

// src/diagrams/architecture/architectureDb.ts
var DEFAULT_ARCHITECTURE_CONFIG = index.defaultConfig_default.architecture;
var ArchitectureDB = class {
  ...
  static {
    index.__name(this, "ArchitectureDB");
  }
  setDiagramId(id) {
    this.diagramId = id;
  }
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      ...
      const BFS = /* @__PURE__ */ index.__name((startingId) => {
...
var populateDb = /* @__PURE__ */ index.__name((ast, db) => {
...
var parser = {
  ...
  parse: /* @__PURE__ */ index.__name(async (input) => {
    const ast = await wardleyL42UT6IY.parse("architecture", input);
    index.log.debug(ast);
...
var wrapIcon = /* @__PURE__ */ index.__name((icon) => {
...
var drawEdges = /* @__PURE__ */ index.__name(async function(edgesEl, cy, db, diagramId) {
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", `${diagramId}-${index.getEdgeId(source, target, { prefix: "L" })}`);
        if (sourceArrow) {
...
var drawGroups = /* @__PURE__ */ index.__name(async function(groupsEl, cy, db, diagramId) {
  const padding = db.getConfigField("padding");
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await index.getIconSVG(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ index.__name(async function(db, elem, services, diagramId) {
  const config = index.getConfig2();
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await index.getIconSVG(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await index.getIconSVG("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html(index.sanitizeText(service.iconText, config));
...
var drawJunctions = /* @__PURE__ */ index.__name(function(db, elem, junctions, diagramId) {
...
index.registerIconPacks([
  {
    name: architectureIcons.prefix,
    icons: architectureIcons
  }
]);
cytoscape_esm.cytoscape.use(fcose);
...
index.__name(addServices, "addServices");
...
index.__name(addJunctions, "addJunctions");
...
index.__name(positionNodes, "positionNodes");
...
index.__name(addGroups, "addGroups");
...
index.__name(addEdges, "addEdges");
function getAlignments(db, spatialMaps, groupAlignments) {
  const flattenAlignments = /* @__PURE__ */ index.__name((alignmentObj, alignmentDir) => {
...
index.__name(getAlignments, "getAlignments");
function getRelativeConstraints(spatialMaps, db) {
  const relativeConstraints = [];
  const posToStr = /* @__PURE__ */ index.__name((pos) => `${pos[0]},${pos[1]}`, "posToStr");
  const strToPos = /* @__PURE__ */ index.__name((pos) => pos.split(",").map((p) => parseInt(p)), "strToPos");
...
index.__name(getRelativeConstraints, "getRelativeConstraints");
function layoutArchitecture(services, junctions, groups, edges, db, { spatialMaps, groupAlignments }) {
  return new Promise((resolve) => {
    const renderEl = index.select("body").append("div").attr("id", "cy").attr("style", "display:none");
    const cy = cytoscape_esm.cytoscape({
    ...
    layout.one("layoutstop", () => {
      ...
      index.__name(getSegmentWeights, "getSegmentWeights");
      cy.startBatch();
    ...
    layout.run();
    cy.ready((e) => {
      index.log.info("Ready", e);
      resolve(cy);
    });
  });
}
index.__name(layoutArchitecture, "layoutArchitecture");
var draw = /* @__PURE__ */ index.__name(async (text, id, _version, diagObj) => {
  const db = diagObj.db;
  db.setDiagramId(id);
  ...
  positionNodes(db, cy);
  index.setupGraphViewbox(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
...
//# sourceMappingURL=architectureDiagram-3BPJPVTR-C6bXlCk_.cjs.map
