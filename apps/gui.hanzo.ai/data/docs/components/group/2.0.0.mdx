...
Group is already installed in `hanzogui`, or you can install it independently:
...
Wrap each of `XGroup` or `YGroup`'s children in one of these. It lets Gui apply the needed styles to them. It accepts the following props:
