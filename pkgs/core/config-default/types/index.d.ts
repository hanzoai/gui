export declare function getDefaultHanzoguiConfig(platform?: 'native' | 'web'): {
    ...
    }> | import("@hanzogui/web").AnimationDriver<{
        '75ms': string;
        '100ms': string;
        '200ms': string;
        bouncy: string;
    ...
    themes: {
        light: {
            background: import("@hanzogui/web").Variable<string>;
            color: import("@hanzogui/web").Variable<string>;
        };
        dark: {
            background: import("@hanzogui/web").Variable<string>;
            color: import("@hanzogui/web").Variable<string>;
    ...
    tokens: {
        color: {
            white: import("@hanzogui/web").Variable<string>;
            black: import("@hanzogui/web").Variable<string>;
        };
        space: {
            [x: string]: import("@hanzogui/web").Variable<number>;
        };
        size: {
            ...
            5.5: import("@hanzogui/web").Variable<number>;
            6: import("@hanzogui/web").Variable<number>;
            6.5: import("@hanzogui/web").Variable<number>;
            7: import("@hanzogui/web").Variable<number>;
            7.6: import("@hanzogui/web").Variable<number>;
            8: import("@hanzogui/web").Variable<number>;
            8.5: import("@hanzogui/web").Variable<number>;
            9: import("@hanzogui/web").Variable<number>;
            9.5: import("@hanzogui/web").Variable<number>;
        ...
        space: {
            [x: string]: import("@hanzogui/web").Variable<any>;
        };
        size: {
            0: import("@hanzogui/web").Variable<number>;
            0.25: import("@hanzogui/web").Variable<number>;
