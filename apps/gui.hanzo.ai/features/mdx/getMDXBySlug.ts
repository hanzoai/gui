...
// resolve @hanzogui/demos so `template=X` fences can inline the XDemo.tsx source.
...
const heroTemplate = {
  ...
  code(node: any, ctx: any) {
    ...
    try {
      ...
      console.warn(`[hanzogui-hero-template] ${templateName}:`, err.message)
    }
  },
}

// hanzogui.dev keeps its native <DocCodeBlock> (copy button, hero collapse, tabs),
