...
description: How Hanzo GUI automatically stacks overlays and floating content
name: z-index
---

Hanzo GUI includes an automatic stacking system that ensures overlays like dialogs, popovers, sheets, and tooltips layer correctly without manual z-index management.

## How It Works

When you open overlay components, Hanzo GUI automatically assigns z-index values so that:
