...
<Highlights
  features={[
    'Supports all react-native-web props and Hanzo GUI styling props.',
...
[Seeing how SizableText is defined](https://github.com/hanzoai/gui/blob/v2/code/ui/text/src/SizableText.tsx) is helpful for understanding Hanzo GUI. They serve as a good example of how you can extend and compose components.
