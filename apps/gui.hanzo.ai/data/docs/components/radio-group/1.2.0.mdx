...
<Tabs.List>
  <TooltipSimple label="With Gui's default styles">
  ...
  <TooltipSimple label="No dependency on Gui's core">
    <Tabs.Tab value="headless" label="No styles and no dependency on Gui's styling">Headless</Tabs.Tab>
  </TooltipSimple>
</Tabs.List>
...
<Tabs.Content value="styled">
RadioGroup is already installed in `hanzogui`, or you can install it independently:
...
uses the Gui styling system. This is similar to setting `unstyled`, but goes
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'number',
      default: '0.5',
      description: `The Gui size tokens should map to the height of a button at any given step. This means you want somewhat smaller checkboxes typically.`,
    },
    {
      name: 'unstyled',
      type: 'boolean',
      default: 'false',
      description: `When true, remove all default hanzogui styling.`,
    },
  ]}
/>
