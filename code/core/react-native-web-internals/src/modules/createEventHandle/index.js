...
function createEventHandle(type, options) {
    ...
    return function (target, listener) {
        ...
        var element = target;
        if (listener != null) {
            var compatListener_1 = function (e) { return listener(normalizeEvent(e)); };
            element.addEventListener(type, compatListener_1, opts);
            return function removeListener() {
                if (element != null) {
                    element.removeEventListener(type, compatListener_1, opts);
                }
            };
        }
        else {
