...
import { createHanzogui, type CreateHanzoguiProps } from 'hanzogui'
// TODO just move this into this folder
import { config as hanzoguiDevConfig } from '../../packages/hanzogui-dev-config/src/index'
import { themeDev } from '../../packages/hanzogui-dev-config/src/theme.dev'
...
export default tamav5Config
  ? createHanzogui(hanzoguiDevConfig)
  : generatedV5
    ? createHanzogui({ ...defaultConfig, themes: generatedV5Themes, animations })
    : v5config
      ? createHanzogui({ ...defaultConfig, animations })
      : tamaConf
