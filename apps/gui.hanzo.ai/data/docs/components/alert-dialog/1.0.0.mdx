...
Alert Dialog is already installed in `hanzogui`, or you can install it independently:
...
```tsx
import { AlertDialog } from 'hanzogui' // or '@hanzogui/alert-dialog'
...
Renders AlertDialog into appropriate container. Beyond [Gui Props](/docs/intro/props), adds:
