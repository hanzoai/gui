...
var isAndroid = process.env.TEST_NATIVE_PLATFORM === "android" || // Android TV has Platform.OS === 'android' per react-native-tvos
process.env.TEST_NATIVE_PLATFORM === "androidtv";
var isIos = process.env.TEST_NATIVE_PLATFORM === "ios" || // tvOS has Platform.OS === 'ios' per react-native-tvos
...
var mediaQueryForceNonOverlap = false ? 1 : 0.02;
var media = {
...
// ../gui-dev-config/dist/esm/gui.dev.config.mjs
...
// ../gui-dev-config/dist/esm/createGenericFont.mjs
...
// ../gui-dev-config/dist/esm/fonts.mjs
...
// ../gui-dev-config/dist/esm/media.mjs
