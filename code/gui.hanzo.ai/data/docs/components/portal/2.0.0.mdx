...
Portal is included in `@hanzo/gui` and is used by [Sheet](/docs/components/sheet),
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          Enable automatic z-index stacking. Hanzo GUI intelligently stacks z-index both
