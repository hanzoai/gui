...
<Highlights
  features={[
    ...
    `Works with every Gui prop.`,
  ]}
/>

## Installation

Form is already installed in `hanzogui`, or you can install it independently:
...
```tsx
import { Form } from 'hanzogui' // or '@hanzogui/form'
...
Accepts [Gui Props](/docs/intro/props).
