...
const arc = require('./arc-DHCUIwPX.cjs');
...
index.__export(timelineDb_exports, {
  addEvent: () => addEvent,
...
var tasks = [];
var rawTasks = [];
var getCommonDb = /* @__PURE__ */ index.__name(() => index.commonDb_exports, "getCommonDb");
...
var setDirection = /* @__PURE__ */ index.__name(function(dir) {
  direction = dir;
}, "setDirection");
...
var addTask = /* @__PURE__ */ index.__name(function(period, length, event) {
  const rawTask = {
    id: currentTaskId++,
...
var addEvent = /* @__PURE__ */ index.__name(function(event) {
...
var nodeCount = 0;
var drawRect = /* @__PURE__ */ index.__name(function(elem, rectData) {
...
var drawSection = /* @__PURE__ */ index.__name(function(elem, section, conf) {
...
var taskCount = -1;
var drawTask = /* @__PURE__ */ index.__name(function(elem, task, conf, diagramId) {
...
var drawBackgroundRect = /* @__PURE__ */ index.__name(function(elem, bounds) {
...
var getTextObj = /* @__PURE__ */ index.__name(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var getNoteRect = /* @__PURE__ */ index.__name(function() {
  return {
    x: 0,
    y: 0,
    width: 100,
...
var initGraphics = /* @__PURE__ */ index.__name(function(graphics, id) {
  nodeCount = 0;
  taskCount = -1;
...
index.__name(wrap, "wrap");
var drawNode = /* @__PURE__ */ index.__name(function(elem, node, fullSection, conf, diagramId, isEvent = false) {
  ...
  if (look === "neo") {
    ...
    if (isReduxTheme) {
      ...
      const rootSvg = index.select(rootSvgNode);
...
var getVirtualNodeHeight = /* @__PURE__ */ index.__name(function(elem, node, conf) {
...
var defaultBkg = /* @__PURE__ */ index.__name(function(elem, node, section, diagramId, config) {
  const { theme } = config;
...
var draw = /* @__PURE__ */ index.__name(function(text, id, version, diagObj) {
  ...
  index.log.debug("timeline", diagObj.db);
  ...
  index.log.debug("task", tasks2);
  svgDraw_default.initGraphics(svg, id);
  const sections2 = diagObj.db.getSections();
  index.log.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    index.log.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  index.log.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    index.log.debug("taskHeight before draw", taskHeight);
  ...
  index.log.debug("maxSectionHeight before draw", maxSectionHeight);
  index.log.debug("maxTaskHeight before draw", maxTaskHeight);
...
var drawTasks = /* @__PURE__ */ index.__name(function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections, diagramId) {
...
var drawEvents = /* @__PURE__ */ index.__name(function(diagram2, events, sectionColor, masterX, masterY, conf, diagramId) {
  ...
  for (const event of events) {
    ...
    index.log.debug("eventNode", eventNode);
...
var draw2 = /* @__PURE__ */ index.__name(function(text, id, version, diagObj) {
  const conf = index.getConfig2();
  const LEFT_MARGIN = conf.timeline?.leftMargin ?? 50;
  index.log.debug("timeline", diagObj.db);
  ...
  if (title) {
    ...
    index.log.debug("bounds after title", box);
  }
  const [fontSize] = index.parseFontSize(conf.fontSize);
...
var drawTasks2 = /* @__PURE__ */ index.__name(function(diagram2, tasks2, sectionColor, timelineX, masterY, maxTaskHeight, conf, taskSpacing, isWithoutSections) {
  for (const task of tasks2) {
    const taskNode = {
      descr: task.task,
      section: sectionColor,
...
var drawEvents2 = /* @__PURE__ */ index.__name(function(diagram2, events, sectionColor, axisX, eventsX, startY, conf) {
  let currentY = startY;
  for (const event of events) {
    const eventNode = {
      descr: event,
...
var genReduxSections = /* @__PURE__ */ index.__name((options) => {
  const { theme } = index.getConfig();
...
var genSections = /* @__PURE__ */ index.__name((options) => {
  let sections2 = "";
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
...
var rendererSelector = {
  ...
  draw: /* @__PURE__ */ index.__name((text, id, version, diagObj) => {
...
//# sourceMappingURL=timeline-definition-PNZ67QCA-B6F1j1O0.cjs.map
