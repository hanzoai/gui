-- This file creates a new product record for the "Gui Pro Team Seats" plan.
...
VALUES (
  ...
  true,
  'Gui Pro Team Seats',
  'Additional seats for Gui Pro plan, allowing team members to access all Pro features.',
