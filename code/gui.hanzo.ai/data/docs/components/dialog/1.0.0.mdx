...
```bash
npm install @hanzo/gui-dialog
```

In order to use this component independently of `@hanzo/gui`, you'll first need to install the `@hanzo/gui-portal` package:
...
```tsx
import { Dialog } from '@hanzo/gui' // or '@hanzo/gui-dialog'
...
Contains every component for the dialog. Beyond [Hanzo GUI Props](/docs/intro/props), adds:
...
Renders Dialog into appropriate container. Beyond [Hanzo GUI Props](/docs/intro/props), adds:
