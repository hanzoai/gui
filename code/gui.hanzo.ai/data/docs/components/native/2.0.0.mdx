...
Hanzo GUI components work great out of the box, but several offer optional native
...
## @hanzo/gui-native Package

The `@hanzo/gui-native` package provides setup utilities for native integrations.
Import the setup modules at your app's entry point, before any Hanzo GUI imports.

```bash
npm install @hanzo/gui-native
```
