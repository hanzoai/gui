...
<Highlights
  features={[
    'Supports all react-native-web props and Gui styling props.',
...
[Seeing how SizableText is defined](https://github.com/hanzogui/hanzogui/blob/v2/pkgs/ui/text/src/SizableText.tsx) is helpful for understanding Gui. They serve as a good example of how you can extend and compose components.
