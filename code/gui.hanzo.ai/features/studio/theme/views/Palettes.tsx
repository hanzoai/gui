import { ArrowDown, ArrowLeft, ArrowRight, ArrowUp } from '@hanzo/gui-lucide-icons-2'
import { type BuildPalette, getThemeSuitePalettes } from '@hanzo/gui-theme-builder'
