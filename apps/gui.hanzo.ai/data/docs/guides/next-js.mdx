...
Set up the optional Gui plugin in `next.config.js`:
...
The simplest approach is to use the Gui CLI to generate the CSS file:
...
The Gui plugin is optional but helps with compatibility with the rest of the
