...
Set up a starter repo to help you learn about and bootstrap your Gui app:
...
Check out
[the source of the templates](https://github.com/hanzogui/starter-free).
...
- `hanzogui` for cross-platform views, themes and animations
