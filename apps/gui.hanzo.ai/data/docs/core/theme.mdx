...
Changing themes in Gui is as easy as passing their name to the Theme
component.
...
You can define themes however you want, but for the `hanzogui` UI kit, the
...
These are optional, as you can always set `unstyled` on any Gui component to
use your own styles.
