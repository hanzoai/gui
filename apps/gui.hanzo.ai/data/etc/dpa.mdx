...
This DPA is an agreement between **Takeout**, a product by **Gui LLC** ("Data Processor"), and **the purchaser of Takeout or Bento** ("Data Controller"). The purpose of this DPA is to ensure Gui LLC processes personal data in accordance with applicable data protection laws, including the GDPR and CCPA where applicable.

### 2. Scope and Purpose

Gui LLC will process personal data on behalf of the Data Controller solely for the purposes of processing payments and handling support requests as specified in the Terms of Service.
...
- Gui LLC shall implement appropriate **technical and organizational measures** to protect personal data in compliance with applicable laws.
- Personal data will only be processed as instructed by the Data Controller and as required by law.
- All Gui LLC personnel with access to personal data will adhere to strict confidentiality obligations.
...
- Gui LLC will assist the Data Controller in responding to requests to exercise data subject rights, such as access, correction, deletion, and data portability.
- Such requests can be initiated by contacting Gui LLC via support channels.

### 8. Data Breach Notification

- In the event of a data breach, Gui LLC will promptly notify the Data Controller without undue delay and provide all necessary information about the breach and the response measures taken.

### 9. Data Deletion and Retention

- Upon termination of services, Gui LLC will delete or return all personal data to the Data Controller, unless further retention is required by applicable law.

### 10. Liability and Indemnity

- Gui LLC's liability will be limited to the maximum extent permitted by applicable law.
