...
import { fetchMessages, sendMessage, type Message } from '~/src/team'
...
// The surface stamps unix milliseconds; the reader wants a clock.
function clock(createdOn: number): string {
