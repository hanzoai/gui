...
Gui supports four animation drivers, each with different strengths for different use cases:
...
Gui provides several ways to use different drivers — at build time per platform, at runtime in specific parts of your app, or dynamically loaded after initial render.
