...
import { GuiProvider, createGui, setMediaState } from '@hanzogui/core'
import React from 'react'
import TestRenderer, { act } from 'react-test-renderer'
import { afterEach, expect, test, vi } from 'vitest'

const conf = createGui(getDefaultGuiConfig('native'))
...
test('Image resolves Gui styles and preserves native image props', async () => {
