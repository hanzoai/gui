...
Separator is already installed in `hanzogui`, or you can install it independently:
...
Separators extend Stack views inheriting all the [Gui standard props](/docs/intro/props), plus:
