...
- `/code/hanzogui.dev/features/site/home/PromoLinksRow.tsx` - Original component with the bug
...
1. **Hanzogui converts x/y props to CSS transform**: When you use `x={100}`, Hanzogui converts it to `transform: translateX(100px)` before passing to the motion driver.
