// Inline notice block used by detail pages — "stack trace requires
// running workflow", "synthetic timeline", etc. Two variants: default
// (neutral border) and destructive (red border).
