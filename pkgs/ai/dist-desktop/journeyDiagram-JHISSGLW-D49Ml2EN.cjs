...
var drawText2 = /* @__PURE__ */ index.__name(function(elem, textData) {
  return chunkND2GUHAM.drawText(elem, textData);
}, "drawText");
...
var taskCount = -1;
var drawTask = /* @__PURE__ */ index.__name(function(elem, task, conf2, diagramId) {
...
var drawTasks = /* @__PURE__ */ index.__name(function(diagram2, tasks2, verticalPos, diagramId) {
  const conf2 = index.getConfig2().journey;
  let lastSection = "";
...
//# sourceMappingURL=journeyDiagram-JHISSGLW-D49Ml2EN.cjs.map
