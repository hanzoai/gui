...
function time() {
  return initRange.apply(calendar(timeTicks, timeTickInterval, timeYear$1, timeMonth$1, timeSunday$1, timeDay$1, timeHour$1, timeMinute$1, second$1, timeFormat$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
}
...
export { diagram };
//# sourceMappingURL=ganttDiagram-6RSMTGT7-DkX-Q0Cq.js.map
