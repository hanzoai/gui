 ...
 * which returns 0 unless @hanzogui/native's safe-area abstraction is enabled against
 * the same module instance the sheet reads (it isn't, when @hanzogui/native is
