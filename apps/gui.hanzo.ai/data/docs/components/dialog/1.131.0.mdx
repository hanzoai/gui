...
If you aren't using `hanzogui` and instead using the `@hanzogui/dialog` package
separately, you'll first need to install the `@hanzogui/portal` package:
...
[Gui Props](/docs/intro/props), adds:
