...
var desat = function (colors, amount) {
    return Object.fromEntries(Object.entries(colors).map(function (_a) {
        var key = _a[0], value = _a[1];
        return [key, (0, color2k_1.desaturate)(value, amount)];
    }));
};
var colorsGreenDark = desat(Colors.greenDark, 0.2);
var colorsGreen = desat(Colors.green, 0.2);
// with color2k:
/**
 * Default themes for the hanzogui.dev site
...
var themes = (0, theme_builder_1.createV4Themes)({
    ...
    base: {
        ...
        extra: {
            light: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, Colors.blue), Colors.gray), colorsGreen), Colors.orange), Colors.pink), Colors.purple), Colors.red), Colors.yellow), lightShadows), blackColors), whiteColors), { shadowColor: lightShadows.shadow1, colorBg: '#fff' }),
            dark: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, Colors.blueDark), Colors.grayDark), colorsGreenDark), Colors.orangeDark), Colors.pinkDark), Colors.purpleDark), Colors.redDark), Colors.yellowDark), darkShadows), blackColors), whiteColors), { shadowColor: darkShadows.shadow1, colorBg: '#000' }),
        },
    },
 ...
 */
exports.hanzoguiThemes = process.env.TAMAGUI_ENVIRONMENT === 'client' && process.env.NODE_ENV === 'production'
    ? {}
    : themes;
