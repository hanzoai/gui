...
Shapes is already installed in `hanzogui`, or you can install it independently:
...
Gui supports sizing shapes using your `size` tokens, or plain numbers.

```tsx
import { Circle, Square } from 'hanzogui'
