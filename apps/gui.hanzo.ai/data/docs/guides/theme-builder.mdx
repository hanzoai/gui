---
title: Creating Themes with Gui
description: Learn how to create a suite of themes for a Gui app
...
<IntroParagraph>
  Gui themes start simple, but can do some pretty powerful things. To make them easier to
  generate, we've built a few helpers. You can always just skip themes, or add a single
