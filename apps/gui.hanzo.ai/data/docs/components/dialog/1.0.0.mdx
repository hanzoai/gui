...
Dialog is already installed in `hanzogui`, or you can install it independently:

```bash
npm install @hanzogui/dialog
```

In order to use this component independently of `hanzogui`, you'll first need to install the `@hanzogui/portal` package:
...
```tsx
import { Dialog } from 'hanzogui' // or '@hanzogui/dialog'
...
Contains every component for the dialog. Beyond [Gui Props](/docs/intro/props), adds:
...
Just [Gui Props](/docs/intro/props).

### Dialog.Portal

Renders Dialog into appropriate container. Beyond [Gui Props](/docs/intro/props), adds:
...
Beyond [Gui Props](/docs/intro/props), adds:
...
Displays behind Content. Beyond [Gui Props](/docs/intro/props), adds:
...
```tsx
import { PortalProvider } from 'hanzogui'
