...
var createTooltip = /* @__PURE__ */ index.__name(() => {
  let tooltipElem = index.select(".mermaidTooltip");
  if (tooltipElem.empty()) {
    tooltipElem = index.select("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0).style("position", "absolute").style("text-align", "center").style("max-width", "200px").style("padding", "2px").style("font-size", "12px").style("background", "#ffffde").style("border", "1px solid #333").style("border-radius", "2px").style("pointer-events", "none").style("z-index", "100");
  }
  return tooltipElem;
}, "createTooltip");
...
//# sourceMappingURL=chunk-ND2GUHAM-B5Kif-rg.cjs.map
