...
<Tabs.Content value="styled">
Tabs is already installed in `hanzogui`, or you can install it independently:
...
```tsx
import { SizableText, Tabs } from 'hanzogui'
...
Use the `createTabs` export to create fully custom tabs that still use the Gui styling system. You provide your own styled frame components and get back a fully functional tabs component.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: `Used to force mounting when more control is needed. Useful when controlling animation with Gui animations.`,
    },
  ]}
/>
