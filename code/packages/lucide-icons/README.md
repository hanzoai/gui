...
[![npm](https://img.shields.io/npm/v/@hanzo/gui-lucide-icons-2.svg)](https://www.npmjs.com/package/@hanzo/gui-lucide-icons-2)
...
### Installation
    ...
    npm install @hanzo/gui-lucide-icons-2 --save
...
```javascript
import { Camera } from '@hanzo/gui-lucide-icons-2'
...
```javascript
import Camera from '@hanzo/gui-lucide-icons-2/dist/icons/camera'
...
```javascript
var Camera = require('@hanzo/gui-lucide-icons-2/dist/icons/camera').default
...
```javascript
import * as Icon from '@hanzo/gui-lucide-icons-2'
