...
export declare const maskOptions: {
    component: {
        ...
        palette?: import("@gui/create-theme").CreateThemePalette;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@gui/create-theme").ThemeMask>;
        overrideShift?: Partial<import("@gui/create-theme").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
    ...
    alt: {
        palette?: import("@gui/create-theme").CreateThemePalette;
        override?: Partial<import("@gui/create-theme").ThemeMask>;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@gui/create-theme").ThemeMask>;
        overrideShift?: Partial<import("@gui/create-theme").ThemeMask>;
        skip?: Partial<import("@gui/create-theme").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
