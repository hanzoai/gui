...
```tsx
import { createV5Theme } from '@hanzo/gui-themes/v5'
...
import { orange, orangeDark } from '@hanzo/gui-colors'
...
```tsx
import { createThemes } from '@hanzo/gui-theme-builder'
...
Or use the CLI: `npx @hanzo/gui-cli generate-themes ./src/themes-in.ts ./src/themes-out.ts`
