...
var isButtonRole = function (element) { return element.getAttribute('role') === 'button'; };
var isPressStartSignal = function (signal) {
    return signal === RESPONDER_INACTIVE_PRESS_START ||
 ...
 */
var PressResponder = /** @class */ (function () {
    ...
    PressResponder.prototype.configure = function (config) {
        this._config = config;
    };
    /**
     * Resets any pending timers. This should be called on unmount.
     */
    PressResponder.prototype.reset = function () {
     ...
     */
    PressResponder.prototype.getEventHandlers = function () {
        if (this._eventHandlers == null) {
            this._eventHandlers = this._createEventHandlers();
        }
        return this._eventHandlers;
    };
    PressResponder.prototype._createEventHandlers = function () {
        var _this = this;
        ...
        var keyupHandler = function (event) {
            ...
            if (_this._touchState !== NOT_RESPONDER && isValidKeyPress(event)) {
                ...
                var isNativeInteractiveElement = role === 'link' ||
                    elementType === 'a' ||
                    elementType === 'button' ||
                    elementType === 'input' ||
                    elementType === 'select' ||
        ...
        return {
            ...
            onResponderGrant: function (event) { return start(event); },
            ...
            onResponderRelease: function (event) { return end(event); },
            ...
            onResponderTerminationRequest: function (event) {
                ...
                var disabled = _this$_config.disabled;
                var onLongPress = _this$_config.onLongPress; // If `onLongPress` is provided, don't terminate on `contextmenu` as default
                // behavior will be prevented for non-mouse pointers.
                if (!disabled &&
                    onLongPress != null &&
                    _this._isPointerTouch &&
     ...
     */
    PressResponder.prototype._receiveSignal = function (signal, event) {
        ...
        if (nextState == null || nextState === ERROR) {
            console.error("PressResponder: Invalid signal ".concat(signal, " for state ").concat(prevState, " on responder"));
        }
     ...
     */
    PressResponder.prototype._performTransitionSideEffects = function (prevState, nextState, signal, event) {
        var _this = this;
    ...
    PressResponder.prototype._activate = function (event) {
    ...
    PressResponder.prototype._deactivate = function (event) {
    ...
    PressResponder.prototype._handleLongPress = function (event) {
        if (this._touchState === RESPONDER_ACTIVE_PRESS_START ||
            this._touchState === RESPONDER_ACTIVE_LONG_PRESS_START) {
            this._receiveSignal(LONG_PRESS_DETECTED, event);
        }
    };
    PressResponder.prototype._cancelLongPressDelayTimeout = function () {
        if (this._longPressDelayTimeout != null) {
            clearTimeout(this._longPressDelayTimeout);
            this._longPressDelayTimeout = null;
        }
    };
    PressResponder.prototype._cancelPressDelayTimeout = function () {
        if (this._pressDelayTimeout != null) {
            clearTimeout(this._pressDelayTimeout);
            this._pressDelayTimeout = null;
        }
    };
    PressResponder.prototype._cancelPressOutDelayTimeout = function () {
