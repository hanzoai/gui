export const animationCode = `import { Button, Square } from 'hanzogui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { Paragraph, View } from 'hanzogui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { View } from 'hanzogui'
      ...
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
          code: `import { useMedia, useTheme, View } from 'hanzogui'
...
import { View, useMedia, useTheme } from 'hanzogui'
