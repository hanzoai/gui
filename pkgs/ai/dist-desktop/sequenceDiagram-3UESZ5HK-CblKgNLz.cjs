...
var drawRect2 = /* @__PURE__ */ index.__name(function(elem, rectData) {
  const rectElement = chunkND2GUHAM.drawRect(elem, rectData);
  if (index.getConfig().look === "neo") {
...
var drawActorTypeParticipant = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      chunkND2GUHAM.drawEmbeddedImage(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      chunkND2GUHAM.drawImage(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  if (!isFooter) {
...
var drawActorTypeCollections = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeQueue = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      chunkND2GUHAM.drawEmbeddedImage(g, iconX, iconY, iconSrc.substr(1));
    } else {
      chunkND2GUHAM.drawImage(g, iconX, iconY, iconSrc);
    }
  }
  _drawTextCandidateFunc(conf2, index.hasKatex(actor.description))(
    actor.description,
...
var drawActorTypeControl = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, diagramId, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeEntity = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeDatabase = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeActor = /* @__PURE__ */ index.__name(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 80;
  const { look, theme, themeVariables } = conf2;
...
var drawActor = /* @__PURE__ */ index.__name(async function(elem, actor, conf2, isFooter, diagramId, diagObj, actorIndexMap) {
...
var drawActivation = /* @__PURE__ */ index.__name(function(_elem, bounds2, verticalPos, conf2, actorActivations2, diagObj, actorIndexMap) {
...
var drawLoop = /* @__PURE__ */ index.__name(async function(elem, loopModel, labelText, conf2, msg) {
  const {
    boxMargin,
    boxTextMargin,
    labelBoxHeight,
  ...
  let txt = chunkND2GUHAM.getTextObj();
  txt.text = labelText;
...
var drawBackgroundRect2 = /* @__PURE__ */ index.__name(function(elem, bounds2) {
  chunkND2GUHAM.drawBackgroundRect(elem, bounds2);
}, "drawBackgroundRect");
...
var insertSequenceNumber = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertDropShadow = /* @__PURE__ */ index.__name(function(elem, conf2) {
  const { theme } = conf2;
...
var insertSolidTopArrowHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertSolidBottomArrowHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertStickTopArrowHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var insertStickBottomArrowHead = /* @__PURE__ */ index.__name(function(elem, id) {
...
var drawNote = /* @__PURE__ */ index.__name(async function(elem, noteModel, id) {
  ...
  const textObj = chunkND2GUHAM.getTextObj();
...
var drawCentralConnection = /* @__PURE__ */ index.__name(function(elem, msg, msgModel, diagObj, startx, stopx, lineStartY) {
  ...
  const getCircleOffset = /* @__PURE__ */ index.__name((isLeftToRight2, isReverse2) => {
  ...
  const drawCircle = /* @__PURE__ */ index.__name((cx) => {
...
var drawMessage = /* @__PURE__ */ index.__name(async function(diagram2, msgModel, lineStartY, diagObj, msg, diagramId) {
  ...
  if (startx === stopx) {
    ...
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${lineStartX},${lineStartY} H ${startx + index.common_default.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
...
var addActorRenderingData = /* @__PURE__ */ index.__name(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.width = index.common_default.getMax(actor.width || conf.width, conf.width);
...
var drawActors = /* @__PURE__ */ index.__name(async function(diagram2, actors, actorKeys, isFooter, diagramId, diagObj, actorIndexMap) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors.get(actorKey);
...
var draw = /* @__PURE__ */ index.__name(async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence, look } = index.getConfig2();
  conf = sequence;
  let sandboxElement;
...
var hasCentralConnection = /* @__PURE__ */ index.__name(function(msg, diagObj) {
  const { CENTRAL_CONNECTION, CENTRAL_CONNECTION_REVERSE, CENTRAL_CONNECTION_DUAL } = diagObj.db.LINETYPE;
...
var calculateCentralConnectionOffset = /* @__PURE__ */ index.__name(function(msg, diagObj, isArrowToRight) {
  const {
...
var isReverseArrowType = /* @__PURE__ */ index.__name(function(msg, diagObj) {
  const {
...
var isBidirectionalArrowType = /* @__PURE__ */ index.__name(function(msg, diagObj) {
...
//# sourceMappingURL=sequenceDiagram-3UESZ5HK-CblKgNLz.cjs.map
