...
export declare const maskOptions: {
    component: {
        ...
        palette?: import("@hanzo/gui-create-theme").CreateThemePalette;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        overrideShift?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
    ...
    alt: {
        palette?: import("@hanzo/gui-create-theme").CreateThemePalette;
        override?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        overrideStrategy?: "shift" | "swap";
        overrideSwap?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        overrideShift?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        skip?: Partial<import("@hanzo/gui-create-theme").ThemeMask>;
        strength?: number;
        max?: number;
        min?: number;
        parentName?: string;
