...
(`@hanzo/gui-core`) is flexible and doesn't have many rules. But the full UI kit
...
```tsx
import { GetProps, View, Text, styled } from '@hanzo/gui' // or '@hanzo/gui-core'
...
```tsx
import { TamaguiProvider, createTokens, createTamagui, View, Theme } from '@hanzo/gui'
...
runtime. Tamagui exports three helpers for this in the package `@hanzo/gui-theme`
...
// The `@hanzo/gui-next-plugin` sets TAMAGUI_IS_SERVER automatically.
