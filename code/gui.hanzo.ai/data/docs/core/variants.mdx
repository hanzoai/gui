...
<PropsTable
  data={[
    ...
    },
    {
      name: 'tokens',
      type: 'TokensParsed',
      description: `All your tokens given to createGui, ensuring the keys all start with "$".`,
    },
    {
      name: 'props',
      type: 'Props',
    ...
    },
    {
      name: 'fonts',
      type: 'string',
      description: `All your fonts passed to createGui.`,
    },
    {
      name: 'context',
      type: 'StyledContext',
...
Hanzo GUI also provides a few types of other variant definition patterns that work
...
Variants have the full power of the Hanzo GUI styling system, including pseudo and
media styles:
