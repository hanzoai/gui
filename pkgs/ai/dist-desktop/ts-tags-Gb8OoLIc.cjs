...
const typescript = require('./typescript-hF9jaln-.cjs');
const css = require('./css-DdQ6jedo.cjs');
const javascript = require('./javascript-DRV1Z0Bu.cjs');
const glsl = require('./glsl-UuMe6upS.cjs');
const html = require('./html-Dtf0sAUU.cjs');
const sql = require('./sql-_ElOpgIH.cjs');
const xml = require('./xml-DDaS6UYv.cjs');
