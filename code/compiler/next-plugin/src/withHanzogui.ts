...
import { HanzoguiPlugin } from 'hanzogui-loader'
import webpack from 'webpack'

const { loadHanzoguiBuildConfigSync } = Static
...
export const withHanzogui = (hanzoguiOptionsIn?: WithHanzoguiProps) => {
  return (nextConfig: any = {}) => {
    ...
    return {
      ...
      webpack: (webpackConfig: any, options: any) => {
        ...
        const hanzoguiPlugin = new HanzoguiPlugin({
          platform: 'web',
          isServer,
          ...hanzoguiOptions,
        })
