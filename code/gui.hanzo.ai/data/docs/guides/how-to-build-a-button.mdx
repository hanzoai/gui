...
```tsx
import { createTamagui, createTokens } from '@hanzo/gui-core'
...
[the Simple Web starter repo source code](https://github.com/hanzoai/gui/blob/main/code/starters/simple-web/src/tamagui.config.ts)
...
```tsx
import { withStaticProperties } from '@hanzo/gui-core'
...
import { SizeTokens, GetProps, withStaticProperties } from '@hanzo/gui-core'
import { Button } from './OurButton'
...
```tsx
import { View, styled, createStyledContext } from '@hanzo/gui-core'
...
```tsx
import { getTokens, useTheme } from '@hanzo/gui-core'
