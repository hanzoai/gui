...
import { createGui } from 'hanzogui' // or '@hanzogui/core'
...
<Notice theme="blue">
  With React 19, Gui automatically injects runtime styles via style tags. The
...
<Notice theme="blue">
  Gui automatically injects styles at runtime. You can optionally generate a static
...
import Head from 'next/head'
import React, { useMemo } from 'react'
import { GuiProvider, createGui } from 'hanzogui'
...
const hanzoguiPlugin = withGui({
  config: './hanzogui.config.ts',
  components: ['hanzogui'],
  outputCSS: process.env.NODE_ENV === 'production' ? './public/hanzogui.generated.css' : null,
...
<Notice theme="green">
  With React 19, Gui automatically injects runtime styles via style tags on the
