...
import { createTamagui } from '@hanzo/gui' // or '@hanzo/gui-core'
...
export default {
  components: ['@hanzo/gui-core'], // or ['tamagui']
...
import { TamaguiProvider } from '@hanzo/gui-core'
...
const { withTamagui } = require('@hanzo/gui-next-plugin')
...
import Head from 'next/head'
import React, { useMemo } from 'react'
import { TamaguiProvider, createTamagui } from '@hanzo/gui'
