...
describe('Package.json exports support', () => {
  ...
  it('should build app package for both web and native targets', () => {
    ...
    execSync(`bun hanzogui build ./packages/app/features --expect-optimizations 10`, {
      cwd: ROOT_DIR,
      encoding: 'utf-8',
      stdio: 'pipe',
    })
  ...
  it('should recognize imports from path-specific exports during optimization', () => {
    ...
    execSync(
      `bun hanzogui build ./packages/app/features/home/screen.tsx --expect-optimizations 10`,
      {
        cwd: ROOT_DIR,
        encoding: 'utf-8',
        stdio: 'pipe',
