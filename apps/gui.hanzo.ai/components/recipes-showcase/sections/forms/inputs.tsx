import { View, YStack } from 'hanzogui'

import * as Inputs from '@hanzogui/recipes/component/forms/inputs'
import { Showcase, WithSize } from '~/components/recipes-showcase/_Showcase'
import {
  type RecipesShowcaseContext,
  RecipesShowcaseProvider,
} from '~/components/recipes-showcase/RecipesProvider'

export function inputs({ isProUser, showAppropriateModal }: RecipesShowcaseContext) {
  return (
    <RecipesShowcaseProvider
      isProUser={isProUser}
