export declare function getDefaultGuiConfig(platform?: 'native' | 'web'): {
    ...
    }> | import("@gui/web").AnimationDriver<{
        '75ms': string;
        '100ms': string;
        '200ms': string;
        bouncy: string;
    ...
    themes: {
        light: {
            background: import("@gui/web").Variable<string>;
            color: import("@gui/web").Variable<string>;
        };
        dark: {
            background: import("@gui/web").Variable<string>;
            color: import("@gui/web").Variable<string>;
    ...
    tokens: {
        color: {
            white: import("@gui/web").Variable<string>;
            black: import("@gui/web").Variable<string>;
        };
        space: {
            [x: string]: import("@gui/web").Variable<number>;
        };
        size: {
            ...
            5.5: import("@gui/web").Variable<number>;
            6: import("@gui/web").Variable<number>;
            6.5: import("@gui/web").Variable<number>;
            7: import("@gui/web").Variable<number>;
            7.6: import("@gui/web").Variable<number>;
            8: import("@gui/web").Variable<number>;
            8.5: import("@gui/web").Variable<number>;
            9: import("@gui/web").Variable<number>;
            9.5: import("@gui/web").Variable<number>;
        ...
        space: {
            [x: string]: import("@gui/web").Variable<any>;
        };
        size: {
            0: import("@gui/web").Variable<number>;
            0.25: import("@gui/web").Variable<number>;
