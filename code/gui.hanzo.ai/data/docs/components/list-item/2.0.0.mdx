...
import { ChevronRight } from '@hanzo/gui-lucide-icons-2' // Example icon
...
import { User } from '@hanzo/gui-lucide-icons-2'
...
```tsx
import { ListItem } from '@hanzo/gui'
import { Star, Settings } from '@hanzo/gui-lucide-icons-2'
...
import { Trash } from '@hanzo/gui-lucide-icons-2'
...
```tsx
import { YStack, ListItem as TamaguiListItem } from '@hanzo/gui'
import { GetProps, styled } from '@hanzo/gui-web'
