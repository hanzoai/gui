...
description: How Gui automatically stacks overlays and floating content
name: z-index
---

Gui includes an automatic stacking system that ensures overlays like dialogs, popovers, sheets, and tooltips layer correctly without manual z-index management.

## How It Works

When you open overlay components, Gui automatically assigns z-index values so that:
...
<Dialog>
  <Dialog.Content>
    ...
    <Tooltip>
      ...
      <Tooltip.Content>I appear above the dialog!</Tooltip.Content>
    </Tooltip>
  </Dialog.Content>
</Dialog>
```
