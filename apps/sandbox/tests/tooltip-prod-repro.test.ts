...
// test against the real gui.dev local server (port 5556)
// to reproduce the stuck tooltip repositioning bug

test.describe('Tooltip repositioning on gui.dev', () => {
  test.skip(
    !process.env.TEST_PROD_SITE,
    'set TEST_PROD_SITE=1 to run against local gui.dev on port 5556'
  )
