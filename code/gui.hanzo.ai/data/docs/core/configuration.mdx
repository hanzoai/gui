...
<Notice theme="blue">
  We recommend starting with [`@hanzo/gui-config/v5`](/docs/core/config-v5), our preset
...
```tsx fileName=tamagui.config.ts
import { createTamagui, getConfig } from '@hanzo/gui'
...
<Notice theme="green">
  ...
  style library only, you can change the imports in this guide out for `@hanzo/gui-core`,
...
```tsx
import { TamaguiProvider, View } from '@hanzo/gui'
...
```tsx fileName="tamagui.config.ts"
import { createFont, createTamagui, createTokens, isWeb } from '@hanzo/gui'
...
- [`@hanzo/gui-animations-css`](/docs/core/animations-css) - CSS transition based
  animations (lightest)
- [`@hanzo/gui-animations-react-native`](/docs/core/animations-react-native) -
  React Native Animated
- [`@hanzo/gui-animations-reanimated`](/docs/core/animations-reanimated) -
  Reanimated for advanced animations
- [`@hanzo/gui-animations-motion`](/docs/core/animations-motion) - Motion with
  WAAPI for web
